...
namespace TrafficControlTest.Module.CollisionEvent
{
	class CollisionPair : ICollisionPair
	{
		...
		public override string ToString()
		{
			...
			result += $"{mName}/{mCollisionRegion.ToString()}/{mPeriod.ToString()}/{mVehicle1.mName}-{mVehicle1.mCurrentState}-{mPassPeriodOfVehicle1WithCurrentVelocity.ToString()}/{mVehicle2.mName}-{mVehicle2.mCurrentState}-{mPassPeriodOfVehicle2WithCurrentVelocity.ToString()}";
			return result;
		}
