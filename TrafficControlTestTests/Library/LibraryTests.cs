...
namespace TrafficControlTest.Library.Tests
{
	...
	public class LibraryTests
	{
		...
		//{
		//	IPoint2D point0 = new Point2D(0, 0);
		//	IPoint2D point1 = new Point2D(10, 10);
		//	IPoint2D point2 = new Point2D(-20, 20);
		//	IPoint2D point3 = new Point2D(-30, -30);
		//	IPoint2D point4 = new Point2D(40, -40);
		//	IPoint2D point5 = new Point2D(100, 0);
		//	IPoint2D point6 = new Point2D(-100, 0);
		//	IPoint2D point7 = new Point2D(100, 100);
		//	IPoint2D point8 = new Point2D(-100, -100);
		//	IPoint2D point9 = new Point2D(0, 100);
		//	IPoint2D point10 = new Point2D(0, -100);

		//	if (GetAngle(point0, point2).ToString("F2") != "135.00") Assert.Fail();
		//	if (GetAngle(point2, point0).ToString("F2") != "-45.00") Assert.Fail();
		//	if (GetAngle(point0, point4).ToString("F2") != "-45.00") Assert.Fail();
		//	if (GetAngle(point4, point0).ToString("F2") != "135.00") Assert.Fail();
		...
		//	IEnumerable<IPoint2D> intersectionPoints1 = Library.GetIntersectionPoint(new Rectangle2D(point1, point3), point0, point5);
		//	if (intersectionPoints1.Count() != 1 || intersectionPoints1.Where((o) => o.ToString() == new Point2D(10, 0).ToString()).Count() != 1) Assert.Fail();
		//	IEnumerable<IPoint2D> intersectionPoints2 = Library.GetIntersectionPoint(new Rectangle2D(point1, point3), point5, point6);
		//	if (intersectionPoints2.Count() != 2 || !intersectionPoints2.Any((o) => o.ToString() == new Point2D(10, 0).ToString()) || !intersectionPoints2.Any((o) => o.ToString() == new Point2D(-30, 0).ToString())) Assert.Fail();
		//	IEnumerable<IPoint2D> intersectionPoints3 = Library.GetIntersectionPoint(new Rectangle2D(point1, point0), point3, point4);
		//	if (intersectionPoints3.Count() != 0) Assert.Fail();
		//	IEnumerable<IPoint2D> intersectionPoints4 = Library.GetIntersectionPoint(new Rectangle2D(point1, point3), point7, point8);
		//	if (intersectionPoints4.Count() != 2 || !intersectionPoints4.Any((o) => o.ToString() == new Point2D(10, 10).ToString()) || !intersectionPoints4.Any((o) => o.ToString() == new Point2D(-30, -30).ToString())) Assert.Fail();
		...
		//	if (linePoints1.ElementAt(0).ToString() != new Point2D(20, 0).ToString()) Assert.Fail();
		//	if (linePoints1.ElementAt(1).ToString() != new Point2D(40, 0).ToString()) Assert.Fail();
		//	if (linePoints1.ElementAt(2).ToString() != new Point2D(60, 0).ToString()) Assert.Fail();
		//	if (linePoints1.ElementAt(3).ToString() != new Point2D(80, 0).ToString()) Assert.Fail();
		//	IEnumerable<IPoint2D> linePoints2 = Library.ConvertLineToPoints(point5, point0, 20);
		//	if (linePoints2.Count() != 4) Assert.Fail();
		//	if (linePoints2.ElementAt(0).ToString() != new Point2D(80, 0).ToString()) Assert.Fail();
		//	if (linePoints2.ElementAt(1).ToString() != new Point2D(60, 0).ToString()) Assert.Fail();
		//	if (linePoints2.ElementAt(2).ToString() != new Point2D(40, 0).ToString()) Assert.Fail();
		//	if (linePoints2.ElementAt(3).ToString() != new Point2D(20, 0).ToString()) Assert.Fail();
		//	IEnumerable<IPoint2D> linePoints3 = Library.ConvertLineToPoints(point0, point10, 20);
		//	if (linePoints3.Count() != 4) Assert.Fail();
		//	if (linePoints3.ElementAt(0).ToString() != new Point2D(0, -20).ToString()) Assert.Fail();
		//	if (linePoints3.ElementAt(1).ToString() != new Point2D(0, -40).ToString()) Assert.Fail();
		//	if (linePoints3.ElementAt(2).ToString() != new Point2D(0, -60).ToString()) Assert.Fail();
		//	if (linePoints3.ElementAt(3).ToString() != new Point2D(0, -80).ToString()) Assert.Fail();
		//	IEnumerable<IPoint2D> linePoints4 = Library.ConvertLineToPoints(point10, point0, 20);
		//	if (linePoints4.Count() != 4) Assert.Fail();
		//	if (linePoints4.ElementAt(0).ToString() != new Point2D(0, -80).ToString()) Assert.Fail();
		//	if (linePoints4.ElementAt(1).ToString() != new Point2D(0, -60).ToString()) Assert.Fail();
		//	if (linePoints4.ElementAt(2).ToString() != new Point2D(0, -40).ToString()) Assert.Fail();
		//	if (linePoints4.ElementAt(3).ToString() != new Point2D(0, -20).ToString()) Assert.Fail();
		//	IEnumerable<IPoint2D> linePoints5 = Library.ConvertLineToPoints(point3, point1, 10);
		//	if (linePoints5.Count() != 5) Assert.Fail();
		//	if (linePoints5.ElementAt(0).ToString() != new Point2D(-23, -23).ToString()) Assert.Fail();
		//	if (linePoints5.ElementAt(1).ToString() != new Point2D(-16, -16).ToString()) Assert.Fail();
		//	if (linePoints5.ElementAt(2).ToString() != new Point2D(-9, -9).ToString()) Assert.Fail();
		//	if (linePoints5.ElementAt(3).ToString() != new Point2D(-2, -2).ToString()) Assert.Fail();
		//	if (linePoints5.ElementAt(4).ToString() != new Point2D(5, 5).ToString()) Assert.Fail();
		//	IEnumerable<IPoint2D> linePoints6 = Library.ConvertLineToPoints(point1, point3, 10);
		//	if (linePoints6.Count() != 5) Assert.Fail();
		//	if (linePoints6.ElementAt(0).ToString() != new Point2D(3, 3).ToString()) Assert.Fail();
		//	if (linePoints6.ElementAt(1).ToString() != new Point2D(-4, -4).ToString()) Assert.Fail();
		//	if (linePoints6.ElementAt(2).ToString() != new Point2D(-11, -11).ToString()) Assert.Fail();
		//	if (linePoints6.ElementAt(3).ToString() != new Point2D(-18, -18).ToString()) Assert.Fail();
		//	if (linePoints6.ElementAt(4).ToString() != new Point2D(-25, -25).ToString()) Assert.Fail();
		//}

		//[TestMethod()]
		//public void RegionIVector2D()
		//{
		//	if (Library.GetVector(10, 10, 30, 30).ToString() != new Vector2D(20.0f, 20.0f).ToString()) Assert.Fail();

		//	if (Library.GetNormalizeVector(new Vector2D(55.0f, 55.0f)).ToString() != new Vector2D(0.71f, 0.71f).ToString()) Assert.Fail();

		//	if (Library.GetDotProduct(new Vector2D(100, 0), new Vector2D(100, 100)).ToString("F2") != "10000.00") Assert.Fail();

		//	if (Library.GetAngleOfTwoVector(new Vector2D(100, 0), new Vector2D(100, 100)).ToString("F2") != "45.00") Assert.Fail();
		//}
		...
		//{
		//	IPoint2D point0 = new Point2D(0, 0);
		//	IPoint2D point1 = new Point2D(0, 10);
		//	IPoint2D point2 = new Point2D(0, -10);
		//	IPoint2D point3 = new Point2D(30, 40);
		//	IPoint2D point4 = new Point2D(-30, -40);
		//	IPoint2D point5 = new Point2D(10, 20);
		//	IPoint2D point6 = new Point2D(0, 40);
		//	IPoint2D point7 = new Point2D(-10, 0);
		//	IPoint2D point8 = new Point2D(90, 10);

		//	if (Library.IsRectangleOverlap(new Rectangle2D(point3, point2), new Rectangle2D(point1, point4)) == true) Assert.Fail();
		//	if (Library.IsRectangleOverlap(new Rectangle2D(point3, point1), new Rectangle2D(point2, point4)) == true) Assert.Fail();
		//	if (Library.IsRectangleOverlap(new Rectangle2D(point3, point4), new Rectangle2D(point0, point1)) == false) Assert.Fail();
		//	if (Library.IsRectangleOverlap(new Rectangle2D(point3, point0), new Rectangle2D(point5, point4)) == false) Assert.Fail();

		//	if (Library.IsPointInside(point0, new Rectangle2D(point3, point4)) == false) Assert.Fail();
		//	if (Library.IsPointInside(point6, new Rectangle2D(point3, point4)) == false) Assert.Fail();
		//	if (Library.IsPointInside(point3, new Rectangle2D(point5, point4)) == true) Assert.Fail();

		//	if (Library.GetCoverRectangle(new Rectangle2D(point3, point0), new Rectangle2D(point5, point4)).ToString() != new Rectangle2D(point3, point4).ToString()) Assert.Fail();
		//	if (Library.GetCoverRectangle(new Rectangle2D(point6, point4), new Rectangle2D(point5, point7)).ToString() != new Rectangle2D(new Point2D(10, 40), point4).ToString()) Assert.Fail();
		//	if (Library.GetCoverRectangle(new Rectangle2D(point3, point5), new Rectangle2D(point0, point4)).ToString() != new Rectangle2D(point3, point4).ToString()) Assert.Fail();

		//	if (Library.GetIntersectionRectangle(new Rectangle2D(point3, point0), new Rectangle2D(point5, point4)).ToString() != new Rectangle2D(point5, point0).ToString()) Assert.Fail();
		//	if (Library.GetIntersectionRectangle(new Rectangle2D(point6, point4), new Rectangle2D(point5, point7)).ToString() != new Rectangle2D(new Point2D(0, 20), point7).ToString()) Assert.Fail();
		//	if (Library.GetIntersectionRectangle(new Rectangle2D(point3, point5), new Rectangle2D(point0, point4)) != null) Assert.Fail();

		//	if (Library.GetRectangle(10, 20, 40).ToString() != new Rectangle2D(new Point2D(50, 60), new Point2D(-30, -20)).ToString()) Assert.Fail();

		//	if (Library.GetAmplifyRectangle(new Rectangle2D(point3, point7), 10, 5).ToString() != new Rectangle2D(new Point2D(40, 45), new Point2D(-20, -5)).ToString()) Assert.Fail();

		//	if (Library.GetCoverRectangle(new List<IPoint2D> { point0, point1, point2, point3, point4, point5, point6, point7 }).ToString() != new Rectangle2D(point3, point4).ToString()) Assert.Fail();

		//	List<IRectangle2D> rectangles1 = new List<IRectangle2D>();
		//	rectangles1.Add(new Rectangle2D(point3, point2));
		//	rectangles1.Add(new Rectangle2D(point5, point0));
		//	rectangles1.Add(new Rectangle2D(point5, point4));
		//	List<IRectangle2D> mergedRectangles1 = Library.MergeRectangle(rectangles1).ToList();
		//	if (mergedRectangles1.Count != 1 || !mergedRectangles1.Any((o) => o.ToString() == new Rectangle2D(point3, point4).ToString())) Assert.Fail();
		//	rectangles1.Add(new Rectangle2D(point8, point0));
		//	List<IRectangle2D> mergedRectangles2 = Library.MergeRectangle(rectangles1).ToList();
		//	if (mergedRectangles2.Count != 1 || !mergedRectangles2.Any((o) => o.ToString() == new Rectangle2D(new Point2D(90, 40), point4).ToString())) Assert.Fail();
		//}
