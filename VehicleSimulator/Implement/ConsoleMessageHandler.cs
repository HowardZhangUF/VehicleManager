...
namespace VehicleSimulator.Implement
{
	class ConsoleMessageHandler : IConsoleMessageHandler
	{
		...
		{
			if (Data != null && rVehicleSimulatorInfo != null && rVehicleSimulatorInfo.mIsInterveneAvailable && rVehicleSimulatorInfo.mIsIntervening && rVehicleSimulatorInfo.mInterveneCommand == "Pause")
			{
				if (Data.Require == null)
				{
					Data.Response = true;
